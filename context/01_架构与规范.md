...
│   │   ├── booking/        # 预订相关模板
│   │   ├── home_preview/   # 首页实验页 layout（/home-preview）
│   │   ├── our_team.html   # Our Team 正式页（/our-team，extends base.html）
│   │   ├── index_experimental.html  # 首页实验页（/home-preview）
│   │   ├── emails/         # 邮件模板
│   │   └── includes/       # 公共组件（主站 nav.html；报名/分期 nav_booking.html；浅色 nav home_preview/nav.html 供 /home-preview 与 /our-team 共用）
│   ├── static/             # 静态资源
│   │   ├── css/            # CSS 文件（含 home-preview.css：/home-preview 与 /our-team 共用，Our Team 样式在 body.our-team-page 下隔离）
│   │   ├── js/             # JavaScript 文件
