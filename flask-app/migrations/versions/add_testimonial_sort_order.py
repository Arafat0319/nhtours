...
Revision ID: add_testimonial_sort_order
...
revision = "add_testimonial_sort_order"
down_revision = "add_testimonials_table"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    if "sort_order" not in columns:
        ...
        rows = conn.execute(sa.text("SELECT id FROM testimonials ORDER BY id")).fetchall()
